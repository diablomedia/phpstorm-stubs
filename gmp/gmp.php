 ...
 * @param resource|string|GMP|int $gmpnumber <p>
 ...
 * @param resource|string|GMP|int $a <p>
 * A number that will be added.
 * </p>
 * It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 * @param resource|string|GMP|int $b <p>
 * A number that will be added.
 * </p>
 * It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 ...
 * @param resource|string|GMP|int $n <p>
 * The number being divided.
 * </p>
 * It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 * @param resource|string|GMP|int $d <p>
 ...
 * @param resource|string|GMP|int $n It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 * @param resource|string|GMP|int $d <p>
 ...
 * @param resource|string|GMP|int $a It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 ...
 * @param resource|string|GMP|int $base <p>
 * The base number.
 * </p>
 * It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 ...
 * It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 * @param resource|string|GMP|int $exp <p>
 * The positive power to raise the <i>base</i>.
 * </p>
 * It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 * @param resource|string|GMP|int $mod <p>
 * The modulo.
 * </p>
 * It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 ...
 * @param string|GMP $bits <p>The number of bits. Either a GMP number resource in PHP 5.5 and earlier,
 ...
 * @param resource|string|GMP|int $a It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 * @param resource|string|GMP|int $b It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 ...
 * @param resource|string|GMP|int $b It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 * @return array|GMP[] An array of GMP numbers.
 * @since 4.0.4
 * @since 5.0
 */
 ...
 * @param resource|string|GMP|int $a It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 * @param resource|string|GMP|int $p It can be either a GMP number resource, or a
 * numeric string given that it is possible to convert the latter to a number.</p>
 * <p>
 ...
 * 1. Index starts at 0.
 * </p>
 * @return GMP|resource A GMP number resource.
 * @since 4.0.4
 * @since 5.0
 */
 ...
 * @param GMP|string $a Either a GMP number resource in PHP 5.5 and earlier, a GMP object in PHP 5.6
